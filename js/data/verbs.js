  ...
  verbs: [
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "estive", meaning: "I was (temporary)", pron: "esh-CHEE-vee", example: "Eu estive em casa o dia todo." },
          { form: "esteve", meaning: "you were (temporary)", pron: "esh-TEH-vee", example: "Você esteve no escritório de manhã?" },
          { form: "estivemos", meaning: "we were (temporary)", pron: "esh-chee-VEH-moosh", example: "Nós estivemos lá no fim de semana." },
          { form: "estiveram", meaning: "you all were (temporary)", pron: "esh-chee-VEH-rahng", example: "Vocês estiveram com a Maria ontem?" },
        ],
        imperfeito: [
          { form: "estava", meaning: "I used to be / was (temporary)", pron: "esh-TAH-vah", example: "Eu estava em casa quando você ligou." },
          { form: "estava", meaning: "you used to be / were (temporary)", pron: "esh-TAH-vah", example: "Você estava sempre cansado na escola?" },
        ...
        subjuntivo: [
          ...
          { form: "estivéssemos", meaning: "if we were (temporary)", pron: "esh-chee-VEH-seh-moosh", example: "Era melhor que nós estivéssemos prontos às oito." },
          { form: "estivessem", meaning: "if you all were (temporary)", pron: "esh-chee-VEH-seng", example: "Ela agiu como se vocês estivessem errados." },
        ],
      },
    },
    {
      ...
      tenses: {
        presente: [
          { form: "tenho", meaning: "I have", pron: "TEH-nyoo", example: "Eu tenho fome." },
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "venho", meaning: "I come", pron: "VEH-nyoo", example: "Eu venho de São Paulo." },
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "fiz", meaning: "I did / made", pron: "FEESH", example: "Eu fiz o jantar ontem." },
    ...
    },
    {
      ...
      tenses: {
        presente: [
          ...
          { form: "pode", meaning: "you can", pron: "PAW-djee", example: "Você pode falar devagar?" },
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "quis", meaning: "I wanted", pron: "KEESH", example: "Eu quis comprar aquele livro." },
          { form: "quis", meaning: "you wanted", pron: "KEESH", example: "Você quis sair mais cedo?" },
        ...
        imperfeito: [
          { form: "queria", meaning: "I wanted / I'd like (polite)", pron: "keh-REE-ah", example: "Eu queria ser médico quando era criança." },
          { form: "queria", meaning: "you wanted / you'd like (polite)", pron: "keh-REE-ah", example: "Você queria um cachorro?" },
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "devi", meaning: "I owed", pron: "deh-VEE", example: "Eu devi dinheiro ao banco por um tempo, mas paguei tudo.", quiz: false },
          { form: "deveu", meaning: "you owed", pron: "deh-VEH-oo", example: "Você já deveu dinheiro a um amigo?", quiz: false },
          { form: "devemos", meaning: "we owed", pron: "deh-VEH-moosh", example: "Nós devemos dinheiro ao banco por anos, mas quitamos tudo.", quiz: false },
          { form: "deveram", meaning: "you all owed", pron: "deh-VEH-rahng", example: "Vocês já deveram dinheiro a alguém?", quiz: false },
        ],
        imperfeito: [
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "esqueci", meaning: "I forgot", pron: "esh-keh-SEE", example: "Eu esqueci o guarda-chuva no ônibus." },
          { form: "esqueceu", meaning: "you forgot", pron: "esh-keh-SEH-oo", example: "Você esqueceu a senha de novo?" },
          { form: "esquecemos", meaning: "we forgot", pron: "esh-keh-SEH-moosh", example: "Nós esquecemos de levar o carregador." },
          { form: "esqueceram", meaning: "you all forgot", pron: "esh-keh-SEH-rahng", example: "Vocês esqueceram o horário da reunião?" },
        ],
        imperfeito: [
          { form: "esquecia", meaning: "I used to forget / was forgetting", pron: "esh-keh-SEE-ah", example: "Eu esquecia o guarda-chuva sempre." },
          { form: "esquecia", meaning: "you used to forget / were forgetting", pron: "esh-keh-SEE-ah", example: "Você esquecia o nome das pessoas?" },
          { form: "esquecíamos", meaning: "we used to forget / were forgetting", pron: "esh-keh-SEE-ah-moosh", example: "Nós esquecíamos de confirmar a reserva." },
          { form: "esqueciam", meaning: "you all used to forget", pron: "esh-keh-SEE-ahng", example: "Vocês esqueciam as tarefas com frequência?" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        presente: [
          ...
          { form: "depende", meaning: "you depend", pron: "deh-PEN-djee", example: "Você depende do tempo que faz?" },
        ...
        perfeito: [
          ...
          { form: "dependeu", meaning: "you depended", pron: "deh-pen-DEH-oo", example: "Você dependeu dessa decisão?" },
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "resolvo", meaning: "I solve", pron: "heh-ZOW-voo", example: "Eu resolvo esse problema agora." },
          { form: "resolve", meaning: "you solve", pron: "heh-ZOW-vee", example: "Você resolve essa questão com ele?" },
          { form: "resolvemos", meaning: "we solve", pron: "heh-zow-VEH-moosh", example: "Nós resolvemos tudo entre nós." },
          { form: "resolvem", meaning: "you all solve", pron: "heh-ZOW-veng", example: "Vocês resolvem isso hoje?" },
        ],
        perfeito: [
          { form: "resolvi", meaning: "I solved / resolved", pron: "heh-zow-VEE", example: "Eu resolvi o problema rapidamente." },
          { form: "resolveu", meaning: "you solved / resolved", pron: "heh-zow-VEH-oo", example: "Você resolveu a questão com o banco?" },
          { form: "resolvemos", meaning: "we solved / resolved", pron: "heh-zow-VEH-moosh", example: "Nós resolvemos tudo antes de sair." },
          { form: "resolveram", meaning: "you all solved / resolved", pron: "heh-zow-VEH-rahng", example: "Vocês resolveram a situação?" },
        ],
        imperfeito: [
          { form: "resolvia", meaning: "I used to solve / resolve / was solving", pron: "heh-zow-VEE-ah", example: "Eu resolvia os problemas sozinha." },
          { form: "resolvia", meaning: "you used to solve / resolve / were solving", pron: "heh-zow-VEE-ah", example: "Você resolvia tudo na base da conversa?" },
          { form: "resolvíamos", meaning: "we used to solve / resolve / were solving", pron: "heh-zow-VEE-ah-moosh", example: "Nós resolvíamos as questões em grupo." },
          { form: "resolviam", meaning: "you all used to solve / resolve", pron: "heh-zow-VEE-ahng", example: "Vocês resolviam os conflitos com calma?" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "morei", meaning: "I lived (reside)", pron: "moh-RAY", example: "Eu morei em Salvador por um ano." },
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "estudei", meaning: "I studied", pron: "esh-too-DAY", example: "Eu estudei para a prova ontem à noite." },
          { form: "estudou", meaning: "you studied", pron: "esh-too-DOH", example: "Você estudou com alguém?" },
          { form: "estudamos", meaning: "we studied", pron: "esh-too-DAH-moosh", example: "Nós estudamos na biblioteca." },
          { form: "estudaram", meaning: "you all studied", pron: "esh-too-DAH-rahng", example: "Vocês estudaram o capítulo todo?" },
        ],
        imperfeito: [
          { form: "estudava", meaning: "I used to study / was studying", pron: "esh-too-DAH-vah", example: "Eu estudava português todos os dias." },
          { form: "estudava", meaning: "you used to study / were studying", pron: "esh-too-DAH-vah", example: "Você estudava muito antes das provas?" },
        ...
        subjuntivo: [
          ...
          { form: "estudássemos", meaning: "if we studied", pron: "esh-too-DAH-seh-moosh", example: "A professora pediu que nós estudássemos o capítulo dois." },
          { form: "estudassem", meaning: "if you all studied", pron: "esh-too-DAH-seng", example: "Gostaria que vocês estudassem antes de sair pra rua." },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "pego", meaning: "I take / grab (bus, Uber)", pron: "PEH-goo", example: "Eu pego o ônibus todo dia." },
          { form: "pega", meaning: "you take / grab (bus, Uber)", pron: "PEH-gah", example: "Você pega o metrô pra ir trabalhar?" },
          { form: "pegamos", meaning: "we take / grab (bus, Uber)", pron: "peh-GAH-moosh", example: "Nós pegamos um táxi pra ir." },
          { form: "pegam", meaning: "you all take / grab (bus, Uber)", pron: "PEH-gahng", example: "Vocês pegam a chave na recepção?" },
        ],
        perfeito: [
          { form: "peguei", meaning: "I took / grabbed (bus, Uber)", pron: "peh-GAY", example: "Eu peguei um táxi para o aeroporto." },
          { form: "pegou", meaning: "you took / grabbed (bus, Uber)", pron: "peh-GOH", example: "Você pegou o ônibus hoje?" },
          { form: "pegamos", meaning: "we took / grabbed (bus, Uber)", pron: "peh-GAH-moosh", example: "Nós pegamos a chave na recepção." },
          { form: "pegaram", meaning: "you all took / grabbed (bus, Uber)", pron: "peh-GAH-rahng", example: "Vocês pegaram os ingressos?" },
        ],
        imperfeito: [
          { form: "pegava", meaning: "I used to take / grab (bus, Uber)", pron: "peh-GAH-vah", example: "Eu pegava o ônibus todo dia." },
          { form: "pegava", meaning: "you used to take / grab (bus, Uber)", pron: "peh-GAH-vah", example: "Você pegava a mochila antes de sair?" },
        ...
        subjuntivo: [
          ...
          { form: "pegássemos", meaning: "if we took / grabbed (bus, Uber)", pron: "peh-GAH-seh-moosh", example: "Era melhor que nós pegássemos um táxi na volta." },
          { form: "pegassem", meaning: "if you all took / grabbed (bus, Uber)", pron: "peh-GAH-seng", example: "Se vocês pegassem o ônibus das sete, chegavam a tempo." },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "volto", meaning: "I return / come back", pron: "VOW-too", example: "Eu volto amanhã." },
          { form: "volta", meaning: "you return / come back", pron: "VOW-tah", example: "Você volta cedo para casa?" },
          { form: "voltamos", meaning: "we return / come back", pron: "vow-TAH-moosh", example: "Nós voltamos depois do almoço." },
          { form: "voltam", meaning: "you all return / come back", pron: "VOW-tahng", example: "Vocês voltam na segunda-feira?" },
        ],
        perfeito: [
          { form: "voltei", meaning: "I returned / came back", pron: "vow-TAY", example: "Eu voltei cedo para casa." },
          { form: "voltou", meaning: "you returned / came back", pron: "vow-TOH", example: "Você voltou tarde da viagem?" },
          { form: "voltamos", meaning: "we returned / came back", pron: "vow-TAH-moosh", example: "Nós voltamos ontem depois do almoço." },
          { form: "voltaram", meaning: "you all returned / came back", pron: "vow-TAH-rahng", example: "Vocês voltaram ontem à noite?" },
        ],
        imperfeito: [
          { form: "voltava", meaning: "I used to return / come back / was returning", pron: "vow-TAH-vah", example: "Eu voltava para casa antes do jantar." },
        ...
        subjuntivo: [
          ...
          { form: "voltasse", meaning: "if you returned", pron: "vow-TAH-see", example: "Gostaria que você voltasse pra casa mais cedo hoje." },
          { form: "voltássemos", meaning: "if we returned", pron: "vow-TAH-seh-moosh", example: "Ela queria que nós voltássemos antes da meia-noite." },
          { form: "voltassem", meaning: "if you all returned", pron: "vow-TAH-seng", example: "Era melhor que vocês voltassem de táxi hoje à noite." },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        presente: [
          ...
          { form: "perguntamos", meaning: "we ask", pron: "pehr-goon-TAH-moosh", example: "Nós perguntamos antes de entrar." },
    ...
    },
    {
      ...
      tenses: {
        presente: [
          ...
          { form: "responde", meaning: "you answer", pron: "hesh-POHN-djee", example: "Você responde a mensagem?" },
        ...
        perfeito: [
          { form: "respondi", meaning: "I answered / replied", pron: "hesh-pohn-DJEE", example: "Eu respondi o e-mail assim que vi." },
          { form: "respondeu", meaning: "you answered / replied", pron: "hesh-pohn-DEH-oo", example: "Você respondeu a mensagem dela?" },
          { form: "respondemos", meaning: "we answered / replied", pron: "hesh-pohn-DEH-moosh", example: "Nós respondemos todas as perguntas." },
          { form: "responderam", meaning: "you all answered / replied", pron: "hesh-pohn-DEH-rahng", example: "Vocês responderam ao convite?" },
        ],
        imperfeito: [
          { form: "respondia", meaning: "I used to answer / respond / was answering", pron: "hesh-pohn-DJEE-ah", example: "Eu respondia todas as mensagens no dia." },
          { form: "respondia", meaning: "you used to answer / respond / were answering", pron: "hesh-pohn-DJEE-ah", example: "Você respondia rápido aos e-mails?" },
          { form: "respondíamos", meaning: "we used to answer / respond / were answering", pron: "hesh-pohn-DJEE-ah-moosh", example: "Nós respondíamos às perguntas com cuidado." },
          { form: "respondiam", meaning: "you all used to answer / respond", pron: "hesh-pohn-DJEE-ahng", example: "Vocês respondiam as ligações sempre?" },
        ],
      },
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "expliquei", meaning: "I explained", pron: "esh-plee-KAY", example: "Eu expliquei tudo com calma." },
          { form: "explicou", meaning: "you explained", pron: "esh-plee-KOH", example: "Você explicou o motivo para ela?" },
          { form: "explicamos", meaning: "we explained", pron: "esh-plee-KAH-moosh", example: "Nós explicamos a situação." },
          { form: "explicaram", meaning: "you all explained", pron: "esh-plee-KAH-rahng", example: "Vocês explicaram como funciona?" },
        ],
        imperfeito: [
    ...
    },
    {
      ...
      tenses: {
        presente: [
          ...
          { form: "chama", meaning: "you call (summon)", pron: "SHAH-mah", example: "Você chama o garçom pra mim?" },
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          ...
          { form: "contamos", meaning: "we told / counted", pron: "kohn-TAH-moosh", example: "Nós contamos os votos juntos." },
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "cozinho", meaning: "I cook", pron: "koh-ZEE-nyoo", example: "Eu cozinho em casa toda semana." },
          { form: "cozinha", meaning: "you cook", pron: "koh-ZEE-nyah", example: "Você cozinha ou pede comida?" },
          { form: "cozinhamos", meaning: "we cook", pron: "koh-zee-NYAH-moosh", example: "Nós cozinhamos pra família no domingo." },
          { form: "cozinham", meaning: "you all cook", pron: "koh-ZEE-nyahng", example: "Vocês cozinham juntos?" },
        ],
        perfeito: [
        ...
        imperfeito: [
          { form: "cozinhava", meaning: "I used to cook / was cooking", pron: "koh-zee-NYAH-vah", example: "Eu cozinhava para a família inteira." },
          { form: "cozinhava", meaning: "you used to cook / were cooking", pron: "koh-zee-NYAH-vah", example: "Você cozinhava em casa todo dia?" },
          { form: "cozinhávamos", meaning: "we used to cook / were cooking", pron: "koh-zee-NYAH-vah-moosh", example: "Nós cozinhávamos juntos nos fins de semana." },
          { form: "cozinhavam", meaning: "you all used to cook", pron: "koh-zee-NYAH-vahng", example: "Vocês cozinhavam a própria comida?" },
        ],
      },
    },
    {
      ...
      tenses: {
        presente: [
          { form: "almoço", meaning: "I have lunch", pron: "ow-MOH-soo", example: "Eu almoço meio-dia em ponto." },
          { form: "almoça", meaning: "you have lunch", pron: "ow-MOH-sah", example: "Você almoça em casa ou na rua?" },
          { form: "almoçamos", meaning: "we have lunch", pron: "ow-moh-SAH-moosh", example: "Nós almoçamos juntos toda sexta." },
          { form: "almoçam", meaning: "you all have lunch", pron: "ow-MOH-sahng", example: "Vocês almoçam no quilo perto do trabalho?" },
        ],
        perfeito: [
          { form: "almocei", meaning: "I had lunch", pron: "ow-moh-SAY", example: "Eu almocei tarde hoje." },
          { form: "almoçou", meaning: "you had lunch", pron: "ow-moh-SOH", example: "Você já almoçou?" },
          { form: "almoçamos", meaning: "we had lunch", pron: "ow-moh-SAH-moosh", example: "Nós almoçamos naquele quilo novo." },
          { form: "almoçaram", meaning: "you all had lunch", pron: "ow-moh-SAH-rahng", example: "Vocês almoçaram onde?" },
        ],
        imperfeito: [
          { form: "almoçava", meaning: "I used to have lunch", pron: "ow-moh-SAH-vah", example: "Eu almoçava na casa da minha avó." },
          { form: "almoçava", meaning: "you used to have lunch", pron: "ow-moh-SAH-vah", example: "Você almoçava na escola?" },
          { form: "almoçávamos", meaning: "we used to have lunch", pron: "ow-moh-SAH-vah-moosh", example: "Nós almoçávamos todos juntos no domingo." },
          { form: "almoçavam", meaning: "you all used to have lunch", pron: "ow-moh-SAH-vahng", example: "Vocês almoçavam no trabalho?" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "assisto", meaning: "I watch", pron: "ah-SEESH-too", example: "Eu assisto televisão." },
          { form: "assiste", meaning: "you watch", pron: "ah-SEESH-chee", example: "Você assiste futebol?" },
          { form: "assistimos", meaning: "we watch", pron: "ah-seesh-CHEE-moosh", example: "Nós assistimos ao filme." },
          { form: "assistem", meaning: "you all watch", pron: "ah-SEESH-teng", example: "Vocês assistem à novela?" },
        ],
        perfeito: [
          { form: "assisti", meaning: "I watched", pron: "ah-seesh-CHEE", example: "Eu assisti ao filme ontem à noite." },
          { form: "assistiu", meaning: "you watched", pron: "ah-seesh-CHEE-oo", example: "Você assistiu ao jogo?" },
          { form: "assistimos", meaning: "we watched", pron: "ah-seesh-CHEE-moosh", example: "Nós assistimos à série no fim de semana." },
          { form: "assistiram", meaning: "you all watched", pron: "ah-seesh-CHEE-rahng", example: "Vocês assistiram à aula toda?" },
        ],
        imperfeito: [
          { form: "assistia", meaning: "I used to watch / attend", pron: "ah-seesh-CHEE-ah", example: "Eu assistia desenho todo dia depois da escola." },
          { form: "assistia", meaning: "you used to watch / attend", pron: "ah-seesh-CHEE-ah", example: "Você assistia novela com a sua mãe?" },
          { form: "assistíamos", meaning: "we used to watch / attend", pron: "ah-seesh-CHEE-ah-moosh", example: "Nós assistíamos filme no sábado à noite." },
          { form: "assistiam", meaning: "you all used to watch / attend", pron: "ah-seesh-CHEE-ahng", example: "Vocês assistiam futebol na TV?" },
        ],
      },
    },
    {
      pt: "escutar", en: "to listen (actively)", category: "Rotina e lazer",
      tenses: {
        presente: [
          { form: "escuto", meaning: "I listen (actively)", pron: "ehsh-KOO-too", example: "Eu escuto música no ônibus." },
          { form: "escuta", meaning: "you listen (actively)", pron: "ehsh-KOO-tah", example: "Você escuta rádio?" },
          { form: "escutamos", meaning: "we listen (actively)", pron: "ehsh-koo-TAH-moosh", example: "Nós escutamos os vizinhos conversando." },
          { form: "escutam", meaning: "you all listen (actively)", pron: "ehsh-KOO-tahng", example: "Vocês escutam esse podcast?" },
        ],
        perfeito: [
          { form: "escutei", meaning: "I listened (actively)", pron: "ehsh-koo-TAY", example: "Eu escutei a música nova ontem." },
          { form: "escutou", meaning: "you listened (actively)", pron: "ehsh-koo-TOH", example: "Você escutou o que ele falou?" },
          { form: "escutamos", meaning: "we listened (actively)", pron: "ehsh-koo-TAH-moosh", example: "Nós escutamos o show inteiro." },
          { form: "escutaram", meaning: "you all listened (actively)", pron: "ehsh-koo-TAH-rahng", example: "Vocês escutaram o barulho?" },
        ],
        imperfeito: [
          { form: "escutava", meaning: "I used to listen (actively) / was listening", pron: "ehsh-koo-TAH-vah", example: "Eu escutava rádio todo dia no carro." },
          { form: "escutava", meaning: "you used to listen (actively) / were listening", pron: "ehsh-koo-TAH-vah", example: "Você escutava música alta?" },
          { form: "escutávamos", meaning: "we used to listen (actively) / were listening", pron: "ehsh-koo-TAH-vah-moosh", example: "Nós escutávamos os discos do meu pai." },
          { form: "escutavam", meaning: "you all used to listen (actively) / were listening", pron: "ehsh-koo-TAH-vahng", example: "Vocês escutavam essa banda?" },
        ],
      },
    },
    {
    ...
    {
      pt: "curtir", en: "to enjoy (slang)", category: "Rotina e lazer",
      tenses: {
        presente: [
          { form: "curto", meaning: "I enjoy / like (slang)", pron: "KOOR-too", example: "Eu curto essa música." },
          { form: "curte", meaning: "you enjoy / like (slang)", pron: "KOOR-chee", example: "Você curte praia?" },
          { form: "curtimos", meaning: "we enjoy / like (slang)", pron: "koor-CHEE-moosh", example: "Nós curtimos o fim de semana na praia." },
          { form: "curtem", meaning: "you all enjoy / like (slang)", pron: "KOOR-teng", example: "Vocês curtem viajar?" },
        ],
        perfeito: [
          { form: "curti", meaning: "I enjoyed / liked (slang)", pron: "koor-CHEE", example: "Eu curti a festa ontem." },
          { form: "curtiu", meaning: "you enjoyed / liked (slang)", pron: "koor-CHEE-oo", example: "Você curtiu o show?" },
          { form: "curtimos", meaning: "we enjoyed / liked (slang)", pron: "koor-CHEE-moosh", example: "Nós curtimos o fim de semana na praia." },
          { form: "curtiram", meaning: "you all enjoyed / liked (slang)", pron: "koor-CHEE-rahng", example: "Vocês curtiram a viagem?" },
        ],
        imperfeito: [
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          ...
          { form: "passeamos", meaning: "we walked / strolled", pron: "pah-say-AH-moosh", example: "Nós passeamos na beira do rio." },
    ...
    },
    {
      ...
      tenses: {
        presente: [
          ...
          { form: "acordamos", meaning: "we wake up", pron: "ah-kohr-DAH-moosh", example: "Nós acordamos com o barulho da rua." },
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "escrevo", meaning: "I write", pron: "esh-KREH-voo", example: "Eu escrevo mensagens em português." },
          { form: "escreve", meaning: "you write", pron: "esh-KREH-vee", example: "Você escreve no caderno?" },
          { form: "escrevemos", meaning: "we write", pron: "esh-kreh-VEH-moosh", example: "Nós escrevemos e-mails no trabalho." },
          { form: "escrevem", meaning: "you all write", pron: "esh-KREH-veng", example: "Vocês escrevem cartas?" },
        ],
        perfeito: [
          { form: "escrevi", meaning: "I wrote", pron: "esh-kreh-VEE", example: "Eu escrevi um e-mail para ela." },
          { form: "escreveu", meaning: "you wrote", pron: "esh-kreh-VEH-oo", example: "Você escreveu a resposta ontem?" },
          { form: "escrevemos", meaning: "we wrote", pron: "esh-kreh-VEH-moosh", example: "Nós escrevemos tudo no caderno." },
          { form: "escreveram", meaning: "you all wrote", pron: "esh-kreh-VEH-rahng", example: "Vocês escreveram para o professor?" },
        ],
        imperfeito: [
          { form: "escrevia", meaning: "I used to write / was writing", pron: "esh-kreh-VEE-ah", example: "Eu escrevia cartas para a minha avó todo mês." },
          { form: "escrevia", meaning: "you used to write / were writing", pron: "esh-kreh-VEE-ah", example: "Você escrevia no diário todo dia?" },
          { form: "escrevíamos", meaning: "we used to write / were writing", pron: "esh-kreh-VEE-ah-moosh", example: "Nós escrevíamos as respostas no quadro." },
          { form: "escreviam", meaning: "you all used to write / were writing", pron: "esh-kreh-VEE-ahng", example: "Vocês escreviam muito no colégio?" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        presente: [
          ...
          { form: "terminamos", meaning: "we finish", pron: "tehr-mee-NAH-moosh", example: "Nós terminamos o projeto na sexta." },
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          ...
          { form: "conseguimos", meaning: "we managed / got", pron: "kohn-seh-GHEE-moosh", example: "Nós conseguimos chegar antes do fechamento." },
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "mostro", meaning: "I show", pron: "MOHSH-troo", example: "Eu mostro o caminho." },
          { form: "mostra", meaning: "you show", pron: "MOHSH-trah", example: "Você mostra o ingresso na entrada?" },
          { form: "mostramos", meaning: "we show", pron: "mohsh-TRAH-moosh", example: "Nós mostramos o apartamento pra eles." },
          { form: "mostram", meaning: "you all show", pron: "MOHSH-trahng", example: "Vocês mostram o que aprenderam?" },
        ],
        perfeito: [
          { form: "mostrei", meaning: "I showed", pron: "mohsh-TRAY", example: "Eu mostrei as fotos para a família." },
          { form: "mostrou", meaning: "you showed", pron: "mohsh-TROH", example: "Você mostrou o projeto para o chefe?" },
          { form: "mostramos", meaning: "we showed", pron: "mohsh-TRAH-moosh", example: "Nós mostramos o caminho para eles." },
          { form: "mostraram", meaning: "you all showed", pron: "mohsh-TRAH-rahng", example: "Vocês mostraram o resultado final?" },
        ],
        imperfeito: [
          { form: "mostrava", meaning: "I used to show / was showing", pron: "mohsh-TRAH-vah", example: "Eu mostrava as fotos para todo mundo." },
          { form: "mostrava", meaning: "you used to show / were showing", pron: "mohsh-TRAH-vah", example: "Você mostrava o caminho para os turistas?" },
          { form: "mostrávamos", meaning: "we used to show / were showing", pron: "mohsh-TRAH-vah-moosh", example: "Nós mostrávamos o projeto na reunião." },
          { form: "mostravam", meaning: "you all used to show", pron: "mohsh-TRAH-vahng", example: "Vocês mostravam o trabalho para o chefe?" },
        ],
      },
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          ...
          { form: "limpamos", meaning: "we cleaned", pron: "leem-PAH-moosh", example: "Nós limpamos o apartamento antes da festa." },
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "tiro", meaning: "I take (a photo) / take off", pron: "CHEE-roo", example: "Eu tiro uma foto." },
          { form: "tira", meaning: "you take (a photo) / take off", pron: "CHEE-rah", example: "Você tira o casaco?" },
          { form: "tiramos", meaning: "we take (a photo) / take off", pron: "chee-RAH-moosh", example: "Nós tiramos uma selfie ali." },
          { form: "tiram", meaning: "you all take (a photo) / take off", pron: "CHEE-rahng", example: "Vocês tiram os sapatos na entrada?" },
        ],
        perfeito: [
          { form: "tirei", meaning: "I took (a photo) / took off", pron: "chee-RAY", example: "Eu tirei uma foto da paisagem." },
          { form: "tirou", meaning: "you took (a photo) / took off", pron: "chee-ROH", example: "Você tirou o casaco antes de entrar?" },
          { form: "tiramos", meaning: "we took (a photo) / took off", pron: "chee-RAH-moosh", example: "Nós tiramos uma selfie no parque." },
          { form: "tiraram", meaning: "you all took (a photo) / took off", pron: "chee-RAH-rahng", example: "Vocês tiraram as malas do carro?" },
        ],
        imperfeito: [
          { form: "tirava", meaning: "I used to take (photos) / take off", pron: "chee-RAH-vah", example: "Eu tirava foto de tudo." },
          { form: "tirava", meaning: "you used to take (photos) / take off", pron: "chee-RAH-vah", example: "Você tirava as dúvidas com o professor?" },
          { form: "tirávamos", meaning: "we used to take (photos) / take off", pron: "chee-RAH-vah-moosh", example: "Nós tirávamos férias no verão." },
          { form: "tiravam", meaning: "you all used to take (photos) / take off", pron: "chee-RAH-vahng", example: "Vocês tiravam o sapato na entrada?" },
        ],
      },
    },
    {
      ...
      tenses: {
        presente: [
          { form: "deixo", meaning: "I leave (behind) / let", pron: "DAY-shoo", example: "Eu deixo a chave na porta." },
          { form: "deixa", meaning: "you leave (behind) / let", pron: "DAY-shah", example: "Você deixa a janela aberta?" },
          { form: "deixamos", meaning: "we leave (behind) / let", pron: "day-SHAH-moosh", example: "Nós deixamos a gorjeta na mesa." },
          { form: "deixam", meaning: "you all leave (behind) / let", pron: "DAY-shahng", example: "Vocês deixam as malas aqui?" },
        ],
        perfeito: [
          { form: "deixei", meaning: "I left (behind) / let", pron: "day-SHAY", example: "Eu deixei o celular em casa." },
          { form: "deixou", meaning: "you left (behind) / let", pron: "day-SHOH", example: "Você deixou a porta aberta?" },
          { form: "deixamos", meaning: "we left (behind) / let", pron: "day-SHAH-moosh", example: "Nós deixamos um recado na secretária." },
          { form: "deixaram", meaning: "you all left (behind) / let", pron: "day-SHAH-rahng", example: "Vocês deixaram as chaves na mesa?" },
        ],
        imperfeito: [
          { form: "deixava", meaning: "I used to leave (behind) / let", pron: "day-SHAH-vah", example: "Eu deixava as chaves na mesa." },
          { form: "deixava", meaning: "you used to leave (behind) / let", pron: "day-SHAH-vah", example: "Você deixava a porta aberta?" },
        ...
        subjuntivo: [
          ...
          { form: "deixássemos", meaning: "if we left (behind) / let", pron: "day-SHAH-seh-moosh", example: "Era melhor que nós deixássemos esse assunto pra amanhã." },
          { form: "deixassem", meaning: "if you all left (behind) / let", pron: "day-SHAH-seng", example: "Saí de fininho antes que vocês deixassem a festa." },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          ...
          { form: "continuamos", meaning: "we continued", pron: "kohn-chee-noo-AH-moosh", example: "Nós continuamos a conversa no café." },
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          ...
          { form: "andamos", meaning: "we walked", pron: "ahn-DAH-moosh", example: "Nós andamos pelo centro." },
          { form: "andaram", meaning: "you all walked", pron: "an-DAH-rahng", example: "Vocês andaram muito hoje?" },
        ],
        imperfeito: [
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "desci", meaning: "I went down / descended", pron: "deh-SEE", example: "Eu desci as escadas correndo." },
          { form: "desceu", meaning: "you went down / descended", pron: "deh-SEH-oo", example: "Você desceu na parada certa?" },
          { form: "descemos", meaning: "we went down / descended", pron: "deh-SEH-moosh", example: "Nós descemos juntos do elevador." },
          { form: "desceram", meaning: "you all went down / descended", pron: "deh-SEH-rahng", example: "Vocês desceram antes ou depois?" },
        ],
        imperfeito: [
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "ponho", meaning: "I put", pron: "POH-nyoo", example: "Eu ponho a comida na mesa." },
        ...
        perfeito: [
          { form: "pus", meaning: "I put", pron: "POOSH", example: "Eu pus a chave na mesa." },
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          ...
          { form: "viraram", meaning: "you all turned (a corner) / became", pron: "vee-RAH-rahng", example: "Vocês viraram na esquina errada?" },
        ],
        imperfeito: [
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "ganho", meaning: "I win / earn", pron: "GAH-nyoo", example: "Eu ganho bem no trabalho." },
          { form: "ganha", meaning: "you win / earn", pron: "GAH-nyah", example: "Você ganha quanto por mês?" },
          { form: "ganhamos", meaning: "we win / earn", pron: "gah-NYAH-moosh", example: "Nós sempre ganhamos desconto aqui." },
          { form: "ganham", meaning: "you all win / earn", pron: "GAH-nyahng", example: "Vocês ganham sempre quando jogam juntos?" },
        ],
        perfeito: [
    ...
    {
      pt: "viver", en: "to live (life, experience — vs. morar)", category: "Sentimentos e percepção",
      tenses: {
        presente: [
          { form: "vivo", meaning: "I live (life, experience)", pron: "VEE-voo", example: "Eu vivo bem com pouco." },
          { form: "vive", meaning: "you live (life, experience)", pron: "VEE-vee", example: "Você vive pra trabalhar?" },
          { form: "vivemos", meaning: "we live (life, experience)", pron: "vee-VEH-moosh", example: "Nós vivemos num país tropical." },
          { form: "vivem", meaning: "you all live (life, experience)", pron: "VEE-veng", example: "Vocês vivem felizes?" },
        ],
        perfeito: [
          { form: "vivi", meaning: "I lived (life, experience)", pron: "vee-VEE", example: "Eu vivi um ano fora do Brasil." },
          { form: "viveu", meaning: "you lived (life, experience)", pron: "vee-VEH-oo", example: "Você viveu isso na pele?" },
          { form: "vivemos", meaning: "we lived (life, experience)", pron: "vee-VEH-moosh", example: "Nós vivemos momentos ótimos juntos." },
          { form: "viveram", meaning: "you all lived (life, experience)", pron: "vee-VEH-rahng", example: "Vocês viveram muita coisa juntos?" },
        ],
        imperfeito: [
          { form: "vivia", meaning: "I used to live / was living (life, experience)", pron: "vee-VEE-ah", example: "Eu vivia sem preocupação naquela época." },
        ...
        subjuntivo: [
          ...
          { form: "vivesse", meaning: "if you lived (life, experience)", pron: "vee-VEH-see", example: "Ela queria que você vivesse a vida com mais calma." },
          { form: "vivêssemos", meaning: "if we lived (life, experience)", pron: "vee-VEH-seh-moosh", example: "Se nós vivêssemos sem celular, conversávamos mais." },
          { form: "vivessem", meaning: "if you all lived (life, experience)", pron: "vee-VEH-seng", example: "Vocês falam como se vivessem no paraíso." },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        presente: [
          { form: "gosto", meaning: "I like", pron: "GOHSH-too", example: "Eu gosto de música." },
          { form: "gosta", meaning: "you like", pron: "GOHSH-tah", example: "Você gosta de café?" },
          { form: "gostamos", meaning: "we like", pron: "gohsh-TAH-moosh", example: "Nós gostamos desse lugar." },
          { form: "gostam", meaning: "you all like", pron: "GOHSH-tahng", example: "Vocês gostam de viajar?" },
        ],
        perfeito: [
          { form: "gostei", meaning: "I liked", pron: "gohsh-TAY", example: "Eu gostei do filme ontem." },
          { form: "gostou", meaning: "you liked", pron: "gohsh-TOH", example: "Você gostou da comida?" },
          { form: "gostamos", meaning: "we liked", pron: "gohsh-TAH-moosh", example: "Nós gostamos da viagem." },
          { form: "gostaram", meaning: "you all liked", pron: "gohsh-TAH-rahng", example: "Vocês gostaram da festa?" },
        ],
        imperfeito: [
          { form: "gostava", meaning: "I used to like", pron: "gohsh-TAH-vah", example: "Eu gostava muito de chocolate." },
          { form: "gostava", meaning: "you used to like", pron: "gohsh-TAH-vah", example: "Você gostava de jogar futebol?" },
        ...
        subjuntivo: [
          ...
          { form: "gostássemos", meaning: "if we liked", pron: "gohsh-TAH-seh-moosh", example: "Ela cozinhou como se nós gostássemos de comida apimentada." },
          { form: "gostassem", meaning: "if you all liked", pron: "gohsh-TAH-seng", example: "Se vocês gostassem do filme, a gente via a sequência." },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        presente: [
          ...
          { form: "encontram", meaning: "you all find / meet", pron: "en-KOHN-trahng", example: "Vocês encontram os amigos no boteco?" },
        ],
        perfeito: [
    ...
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "esperei", meaning: "I waited / hoped", pron: "esh-peh-RAY", example: "Eu esperei meia hora no ponto." },
          { form: "esperou", meaning: "you waited / hoped", pron: "esh-peh-ROH", example: "Você esperou a resposta?" },
          { form: "esperamos", meaning: "we waited / hoped", pron: "esh-peh-RAH-moosh", example: "Nós esperamos até tarde." },
          { form: "esperaram", meaning: "you all waited / hoped", pron: "esh-peh-RAH-rahng", example: "Vocês esperaram na fila?" },
        ],
        imperfeito: [
          { form: "esperava", meaning: "I used to wait / hope", pron: "esh-peh-RAH-vah", example: "Eu esperava o ônibus todo dia na mesma parada." },
        ...
        subjuntivo: [
          ...
          { form: "esperasse", meaning: "if you waited / hoped", pron: "esh-peh-RAH-see", example: "Queria que você esperasse a gente na saída do metrô." },
          { form: "esperássemos", meaning: "if we waited / hoped", pron: "esh-peh-RAH-seh-moosh", example: "Era melhor que nós esperássemos a chuva passar primeiro." },
          { form: "esperassem", meaning: "if you all waited / hoped", pron: "esh-peh-RAH-seng", example: "Cheguei antes que vocês esperassem demais por mim." },
        ],
      },
    },
    {
      ...
      tenses: {
        ...
        perfeito: [
          { form: "segui", meaning: "I followed", pron: "seh-GHEE", example: "Eu segui as instruções do manual." },
          { form: "seguiu", meaning: "you followed", pron: "seh-GHEE-oo", example: "Você seguiu o conselho dela?" },
          { form: "seguimos", meaning: "we followed", pron: "seh-GHEE-moosh", example: "Nós seguimos o grupo pela trilha." },
          { form: "seguiram", meaning: "you all followed", pron: "seh-GHEE-rahng", example: "Vocês seguiram o roteiro planejado?" },
        ],
        imperfeito: [
          { form: "seguia", meaning: "I used to follow / was following", pron: "seh-GHEE-ah", example: "Eu seguia as instruções à risca." },
          { form: "seguia", meaning: "you used to follow / were following", pron: "seh-GHEE-ah", example: "Você seguia as notícias com atenção?" },
          { form: "seguíamos", meaning: "we used to follow / were following", pron: "seh-GHEE-ah-moosh", example: "Nós seguíamos a mesma rotina todo dia." },
          { form: "seguiam", meaning: "you all used to follow", pron: "seh-GHEE-ahng", example: "Vocês seguiam as redes sociais dela?" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      tenses: {
        presente: [
          ...
          { form: "marcamos", meaning: "we schedule", pron: "mahr-KAH-moosh", example: "Nós marcamos pra sexta-feira." },
